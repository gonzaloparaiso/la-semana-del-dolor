  ...
  return (
    <div style={{ backgroundColor: "#121212", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <div className="urgency-bar">
        Plazas limitadas · Elige tu plan y empieza a recuperarte hoy
      </div>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "5rem", paddingBottom: "5rem" }}>
          <div style={{ maxWidth: "620px" }}>
            ...
            >
              Low Back Armour: el sistema completo de 3 meses con Alba Estrada para reeducar tu movimiento y recuperar la confianza en tu espalda.
            </p>
            <p
              style={{
                fontFamily: "'Montserrat', sans-serif",
            ...
            >
              Para personas con dolor lumbar que quieren volver a moverse con seguridad. Elige el plan que mejor encaje contigo.
            </p>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <div className="fade-in-up">
            ...
            >
              Sí. Y vamos a conseguirlo juntos. Elige tu plan de Low Back Armour y empieza hoy. Las plazas son limitadas.
            </p>
            <a
              href="#precio"
              className="btn-gold btn-gold-pulse"
